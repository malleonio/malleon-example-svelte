...
Get up and running with the Malleon Replay SDK Svelte example in 3 steps:
...
This will install Svelte dependencies and the `@malleon/replay` SDK package.
...
Then open `http://localhost:4203` in your browser.
